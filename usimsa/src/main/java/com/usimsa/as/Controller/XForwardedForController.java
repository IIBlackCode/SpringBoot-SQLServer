package com.usimsa.as.Controller;
...
import com.usimsa.as.VO.Client;
import com.usimsa.as.VO.PCMonitorChartVO;
import com.usimsa.as.VO.PCMonitorVO;
import com.usimsa.as.VO.UserVO;
...
@Slf4j
@RequestMapping("/x-forwarded-for/")
@Controller

public class XForwardedForController {
private Logger logger = LoggerFactory.getLogger(this.getClass());
	
	@GetMapping({"index",""})
	public ModelAndView index(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("XForwardedFor/index");
...
//		modelAndView.addObject("pcMonitorVO", pcMonitorVO);
	...
	public ModelAndView getLogin(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("/XForwardedFor/login");
...
//		return modelAndView;
		return "redirect:XForwardedFor/test";
	}
